window.addEventListener('load', () => {
    ...
    function buildMenu(data) {
        ...
        let parentDesktop = document.querySelector(".nav-wrapper ul");
        ...
        data.forEach(item => {
            ...
            aDesktop.textContent = item.name + "\xa0\xa0\xa0" + "|" + "\xa0\xa0";




            aMobile.style.textDecoration = "none";
            aMobile.style.fontSize = "3.5em";
            aMobile.style.lineHeight = "2em";
            aMobile.style.fontFamily = "Work Sans";
            liMobile.style.textAlign = "center";
